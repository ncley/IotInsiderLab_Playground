...
namespace AdminApi
{
    public class SwaggerConfig
    {
        ...
        {
            //return HttpContext.Current.Server.MapPath("~/App_Data/AdminApi.xml");
            return System.String.Format(@"{0}\App_Data\AdminApi.XML", System.AppDomain.CurrentDomain.BaseDirectory);
        }
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "AdminApi");
